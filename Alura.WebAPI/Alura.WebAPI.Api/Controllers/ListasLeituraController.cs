...
namespace Alura.ListaLeitura.Api.Controllers
{
    ...
    public class ListasLeituraController : ControllerBase
    {
        ...
        private Lista CriaLista(TipoListaLeitura tipo) //Lista = Alura.ListaLeitura.Modelos.ListaLeitura;
        {
            return new Lista
            {
                ...
                Livros = _repo.All
                    ...
                    .Select(l => l.ToApi()) //é criado como uma Lista. Usar o ToApi para converter para listaApi
                    .ToList()
            };
        }
