...
namespace Alura.ListaLeitura.WebApp.Controllers
{
    ...
    public class LivroController : Controller
    {
        ...
        {
            return _repo.Find(id); //Quando o retorno é um objeto, o AspNet retornará em Json.
        }
        ...
        public IActionResult Detalhes(int id)
        {
            ...
            return View(model.ToModel()); //O método view é o método que entrega uma instância de ViewResult.
        }
